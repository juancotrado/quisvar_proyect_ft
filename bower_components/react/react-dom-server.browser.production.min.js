  ...
  function ba(a, b) {
    ...
    if (f) {
      if (
        null == b ||
        (f.hasBooleanValue && !b) ||
        (f.hasNumericValue && isNaN(b)) ||
        (f.hasPositiveNumericValue && 1 > b) ||
        (f.hasOverloadedBooleanValue && !1 === b)
      )
        return '';
      var c = f.attributeName;
      if (f.hasBooleanValue || (f.hasOverloadedBooleanValue && !0 === b))
        return c + '\x3d""';
      if ('boolean' !== typeof b || J(a))
        return c + '\x3d' + ('"' + t(b) + '"');
  ...
  function ea(a, b) {
    for (; q.isValidElement(a); ) {
      ...
      if (c.prototype && c.prototype.isReactComponent)
        var d = new c(f.props, a, e);
      else if (((d = c(f.props, a, e)), null == d || null == d.render)) {
        a = d;
        P(a, c);
        continue;
      }
      ...
      if (d.componentWillMount)
        if ((d.componentWillMount(), l.length)) {
          e = l;
          var h = g;
          l = null;
          g = !1;
          if (h && 1 === e.length) d.state = e[0];
          else {
            var k = h ? e[0] : d.state,
              m = !0;
            for (h = h ? 1 : 0; h < e.length; h++) {
              var p = e[h];
              if ((p = 'function' === typeof p ? p.call(d, k, f.props, a) : p))
                m ? ((m = !1), (k = w({}, k, p))) : w(k, p);
            }
            d.state = k;
          }
      ...
      if ('function' === typeof d.getChildContext) {
        ...
        'object' !== typeof f ? n('107', G(c) || 'Unknown') : void 0;
        var t = d.getChildContext();
        for (var x in t) x in f ? void 0 : n('108', G(c) || 'Unknown', x);
      }
      t && (b = w({}, b, t));
    }
    ...
    Q = {
      ...
      injectDOMPropertyConfig: function (a) {
        ...
        for (var g in f) {
          ...
          1 >=
          e.hasBooleanValue + e.hasNumericValue + e.hasOverloadedBooleanValue
            ? void 0
            : n('50', g);
    ...
    W = (function () {
      function a(b, f) {
        ...
        q.isValidElement(b)
          ? b.type !== T
            ? (b = [b])
            : ((b = b.props.children), (b = q.isValidElement(b) ? [b] : C(b)))
          : (b = C(b));
        this.stack = [
          {
      ...
      a.prototype.read = function (a) {
        ...
        for (var b = ''; b.length < a; ) {
          ...
          if (c.childIndex >= c.children.length) {
            ...
            (l = c.children[c.childIndex++]),
              (b += this.render(l, c.context, c.domNamespace));
        }
        return b;
      };
      ...
      a.prototype.renderDOM = function (a, f, c) {
        ...
        if ('input' === b)
          ...
          if (null != d) {
            ...
            g = w({ selected: void 0, children: void 0 }, g, {
              selected: e,
              children: h,
            });
          }
        ...
        a: {
          ...
          if (null != d) {
            ...
            ((d = g.children), 'string' === typeof d || 'number' === typeof d)
          ) {
            d = t(d);
            break a;
          }
