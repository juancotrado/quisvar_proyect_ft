...
(function (p, l) {
  ...
  function F(a, b, c) {
    ...
    if (a && a.defaultProps)
      for (e in ((g = a.defaultProps), g)) void 0 === f[e] && (f[e] = g[e]);
    return {
      $$typeof: r,
      type: a,
      key: d,
  ...
  function q(a, b, c, e) {
    ...
    else if (((g = (K && a[K]) || a['@@iterator']), 'function' === typeof g))
      for (a = g.call(a), h = 0; !(f = a.next()).done; )
  ...
  var E = d,
    w = {
      ...
      enqueueReplaceState: function (a, b, c, e) {},
    ...
    cloneElement: function (a, b, c) {
      ...
      if (null != b) {
        ...
        for (k in b)
          G.call(b, k) &&
            !H.hasOwnProperty(k) &&
            (e[k] = void 0 === b[k] && void 0 !== g ? g[k] : b[k]);
      }
