...
import { contarStatus } from '../../../pages/attendance/ContarStatus';
        ...
        <View style={{ ...styles.table, width: '80%' }}>
          ...
          {data &&
            data.map((value, index) => {
              const counts = contarStatus(value);
              return (
...
const AttendanceRangePdf = ({ data, rangeDate }: AttendanceRangePdfProps) => {
...
export default AttendanceRangePdf;
