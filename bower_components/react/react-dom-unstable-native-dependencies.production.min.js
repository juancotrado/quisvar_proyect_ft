...
(function (C, l) {
  'object' === typeof exports && 'undefined' !== typeof module
    ? (module.exports = l(require('react-dom'), require('react')))
    : 'function' === typeof define && define.amd
    ? define(['react-dom', 'react'], l)
    : (C.ReactDOMUnstableNativeDependencies = l(C.ReactDOM, C.React));
})(this, function (C, l) {
  function z(a) {
    for (
  ...
  function S(a, b, c) {
    if ((b = Q(a, c.dispatchConfig.phasedRegistrationNames[b])))
      (c._dispatchListeners = I(c._dispatchListeners, b)),
        (c._dispatchInstances = I(c._dispatchInstances, a));
  }
  function Z(a) {
  ...
  function A(a) {
    if (a && a.dispatchConfig.registrationName) {
      ...
      if (b && a && a.dispatchConfig.registrationName) {
        ...
        c &&
          ((a._dispatchListeners = I(a._dispatchListeners, c)),
          (a._dispatchInstances = I(a._dispatchInstances, b)));
      }
    }
  }
  function B(a, b, c, f) {
  ...
  L(B.prototype, {
    ...
    destructor: function () {
      ...
      for (a = 0; a < X.length; a++) this[X[a]] = null;
    },
  });
  B.Interface = l;
  ...
  var p = [],
    ...
    r = {
      recordTouchTrack: function (a, b) {
        if (H(a)) b.changedTouches.forEach(ea);
        else if (D(a))
